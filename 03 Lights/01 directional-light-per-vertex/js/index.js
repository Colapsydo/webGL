...
function createObject(type){
	...
	object.setMaterialShininess(28.0+Math.random()*100.0);
	...
	object.scale = [.1 + Math.random() * .4, .1 + Math.random() * .4, .1 + Math.random() * .4];
...
var Object = function() {
		function init(model) {
				...
				this.setMaterialAmbient(vec4(1.0,0.2,0.8,1.0));
